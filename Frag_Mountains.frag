...
void main()
{
	...
	// Diffúz komponens
	// A diffúz fényforrásból érkezõ fény mennyisége arányos a fényforrásba mutató vektor és a normálvektor skaláris szorzatával
	// és az attenuációval
	...
	// A spekuláris komponens a tökéletes visszaverõdés iránya és a kamera irányától függ.
